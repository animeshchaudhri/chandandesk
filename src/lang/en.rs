...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Qbdesk Desk network..."),
        ...
        ("install_tip", "Due to UAC, Qbdesk Desk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Qbdesk Desk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Qbdesk Desk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Qbdesk Desk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Qbdesk Desk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Qbdesk Desk Input] service."),
        ...
        ("doc_mac_permission", "https://Qbdesk Desk.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Qbdesk Desk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Qbdesk Desk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Qbdesk Desk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Qbdesk Desk."),
        ...
        ("verify_Chandan Desk_password_tip", "Verify Qbdesk Desk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Qbdesk Desk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_Chandan Desk_server_pro_to_{}_tip", "Please upgrade Qbdesk Desk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://Qbdesk Desk.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Qbdesk Desk from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Qbdesk Desk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Qbdesk Desk window is open"),
        ...
        ("floating_window_tip", "It helps to keep Qbdesk Desk background service"),
